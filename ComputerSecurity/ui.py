...
def app_configuration(app: Flask):
    ...
    app.config["MAIL_USERNAME"] = "postmaster@sandbox4e40055657fc4248862c355a2b7b5878.mailgun.org"
    app.config["MAIL_PASSWORD"] = "d9143d6367e00502f69ab6bab5eb77bb-3724298e-05970d5e"
